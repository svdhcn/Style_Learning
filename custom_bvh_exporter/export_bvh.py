    ...
    for frame in range(frame_start, frame_end + 1):
        ...
        for dbone in bones_decorated:
            ...
            if not dbone.skip_position:
                file.write("%.6lf %.6lf %.6lf " % (loc * global_scale)[:])

            file.write("%.6lf %.6lf %.6lf " % (degrees(rot[dbone.rot_order[0]]), degrees(rot[dbone.rot_order[1]]), degrees(rot[dbone.rot_order[2]])))
